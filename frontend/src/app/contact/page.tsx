            ...
            <div className="container">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                        Have a question, suggestion, or want to work with us? We&#39;d love to hear from you. Fill out the form below or reach out directly through our contact information.
                    </p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:info@autoverse.com" className="text-muted-foreground hover:text-primary">
                                                info@autoverse.com
                                            </a>
                                        </div>
                                    </div>
